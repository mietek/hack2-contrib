...
module Hack2.Contrib.Middleware.ShowStatus (show_status) where


import Data.Maybe
import Hack2
import Hack2.Contrib.Constants
import Hack2.Contrib.Request hiding (body)
...
<body>
  ...
  <div id="explanation">
    <p>
    You're seeing this error because you use <code>Hack2.Contrib.Middleware.ShowStatus</code>.
    </p>
  </div>
</body>
</html>
